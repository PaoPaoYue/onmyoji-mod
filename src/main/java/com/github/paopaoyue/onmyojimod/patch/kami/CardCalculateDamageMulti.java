...
public class CardCalculateDamageMulti {

    public CardCalculateDamageMulti() {
    }
    ...
    public static void Insert(AbstractCard __instance, AbstractMonster mo, DamageInfo.DamageType ___damageTypeForTurn, float[] tmp) {
