...
public class CardApplyPowers {
    public CardApplyPowers() {
    }
    ...
    public static void Insert(AbstractCard __instance, DamageInfo.DamageType ___damageTypeForTurn, @ByRef float[] tmp) {
